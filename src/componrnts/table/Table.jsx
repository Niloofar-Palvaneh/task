    ...
    return (
        <>
            <div className="w-full p-4 mt-24 mb-12 flex flex-col  items-center justify-center">
                <div className={`z-50 text-center p-8 ${showEditModal ? "flex flex-col gap-2" : "hidden"} w-[400px] h-[350px] bg-gray-300 absolute border border-4  border-green-500 rounded`}>
                    <p >
                    ...
                    <button className="bg-green-600 mt-8 px-4 py-2 rounded-xl text-white flex items-end justify-center gap-2 group" onClick={updateHandler}>
                        <span>Update</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 group-hover:translate-x-1 transition-all">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99" />
                        </svg>

                    </button>
                    <button className="bg-green-600 mt-8 px-4 py-2 rounded-xl text-white flex items-end justify-center gap-2 group" onClick={cancleChanges}>
                        <span>Cancle</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 group-hover:translate-x-1 transition-all">
